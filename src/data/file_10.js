export const data = [
  ...
  },
  {
    ...
    "in": "Disunnahkan bagi anda saat hendak mendekat ke Safa pada permulaan lintasan pertama untuk membaca,  إِنَّ ٱلصَّفَا وَٱلْمَرْوَةَ مِن شَعَآئِرِ ٱللَّهِ ۖ فَمَنْ حَجَّ ٱلْبَيْتَ أَوِ ٱعْتَمَرَ فَلَا جُنَاحَ عَلَيْهِ أَن يَطَّوَّفَ بِهِمَا ۚ وَمَن تَطَوَّعَ خَيْرًا فَإِنَّ ٱللَّهَ شَاكِرٌ عَلِيمٌ \"Innas Shafa wal Marwata min sya'aairillah. Faman hajjal baita aui'tamara fala junaaha 'alaihi an yattawwafa bihima. waman tathawwa'a khairan fa innallaha syaakirun 'aliim.\" Kemudian membaca, \"Aku mulai dengan apa yang Allah mulai.\" Ucapan ini hanya dikatakan di awal lintasan pertama..",
  ...
  },
  {
    ...
    "mal": "Pada permulaan setiap pusingan sai, di Bukit Safa dan Bukit Marwah anda disunatkan untuk menghadap kiblat dan mengucapkan:\"Allahu Akbar, Allahu Akbar, Allahu Akbar. La ilaha illallah wahdahu la sharika lahu, lahu al-mulk wa lahu al-hamdu wa huwa 'ala kulli shay'in qadir. La ilaha illallah wahdahu, anjaza wa'dahu, wa nasara 'abdahu, wa hazama al-ahzaba wahdahu.\" (Allah Maha Besar, Allah Maha Besar, Allah Maha Besar. Tiada Tuhan selain Allah, Yang Maha Esa, tiada sekutu bagiNya, bagiNya segala kerajaan dan pujian, dan Dia Maha Kuasa atas segala sesuatu. Tiada Tuhan selain Allah, Yang Maha Esa, telah menepati janjiNya, menolong hambaNya, dan mengalahkan golongan yang bersekutu)Kemudian, anda boleh berdoa dengan doa-doa yang anda hajatkan. Kemudian ulangilah ucapan takbir dan tahlil serta doa tersebut sekali lagi sebelum anda memulakan pusingan pertama. Anda dituntut untuk melakukan ibadah ini pada permulaan setiap pusingan di Bukit Safa dan Bukit Marwah.",
  ...
  },
  {
    ...
    "mal": "Disunatkan bagi lelaki untuk berlari-lari anak di antara dua lampu hijau.Adapun kaum wanita, mereka tidak disunatkan untuk berlari-lari anak antara dua lampu hijau; sebaliknya, mereka hanya perlu berjalan sahaja sepanjang perlaksanaan ibadah sa'i. Begitu juga hukum bagi orang yang menemani kaum wanita semasa sa'i.",
    "fr": "Il est recommandé aux hommes de hâter le pas entre les signaux lumineux de couleur verte. Quant aux femmes, elles se contentent de marcher tout au long des parcours et ne se précipitent pas dans la zone marquée par les signaux lumineux. Les hommes qui accompagnent des femmes marcheront également au rythme de ces dernières.",
