export const congratsData = {
  ar: {
    ...
    musaliyaatDesc:
      "خدمة إلكترونية إثرائية تتيح للمصلي الوصول إلى المعلومات الدينية أثناء انتظاره للصلاة، مثل الأدعية، الأذكار، المصحف الشريف، والدروس الدينية، لتعزيز تجربته الروحانية وجعلها أكثر ثراءً وعمقًا.",
  },
  en: {
    exploreServices: "Browse Our Services",
  ...
  fr: {
    ...
    makeRequest: "Demande de service",
    musaliyaatTitle: "Guide du fidèle",
    musaliyaatDesc:
      "Une plateforme interactive permettant aux fidèles d’accéder à des ressources religieuses enrichissantes durant leur attente avant la prière, incluant des invocations, des évocations,  le Saint Coran et des cours religieux. Une expérience spirituelle riche et profonde.",
  },
  tr: {
    exploreServices: "Hizmetlerimize Göz Gezdirin",
  ...
  in: {
    ...
    musaliyaatTitle: "Panduan Jamaah Shalat",
    musaliyaatDesc:
      "Layanan digital yang menyediakan informasi keagamaan untuk jamaah saat menunggu shalat, seperti doa-doa, dzikir, mushaf al-Qur'an, dan kajian agama, untuk meningkatkan pengalaman spiritual mereka dan menjadikannya lebih bermakna dan berkesan.",
  },
  mal: {
