export const data = [
  ...
  },
  {
    ...
    "ur": "اے اللہ! میں نے خود کو تیرے سپرد کردیا، تیرے اوپر ایمان لایا، تجھ پر بھروسہ کیا، تیری طرف رجوع کیا اور تیری مدد سے لڑا۔ اے اللہ! میں اس بات سے تیری عزت کی پناہ لیتا ہوں ۔۔ تیرے سوا کوئی معبود نہیں ۔۔ کہ تو مجھے سیدھی راہ سے ہٹا دے ۔۔ تو ہی ہمیشہ زندہ رہنے والا ہے جس کو موت نہیں آسکتی اور جن و انس سب مر جائیں گے۔",
    "subtitle": {
      "ar": "الأدعية",
      "en": "Supplications",
      "tr": null,
  ...
  },
  {
    ...
    "ur": "اے اللہ ایمان کو  ہمارے لیے محبوب کردے اور اسے ہمارے دلوں کی زینت بنا ، کفر، فسق اور نافرمانی کو ہمارے لیے مبغوض بنا دے اور ہمیں ہدایت یافتہ لوگوں میں سے بنا ",
    "subtitle": {
      "ar": "الأدعية",
      "en": "Supplications",
      "tr": null,
