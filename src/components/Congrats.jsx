    ...
    <Box textAlign="center">
      <Modal isOpen={isOpen} onClose={closeModal} isCentered>
        ...
        >
          <ModalBody>
            <Stack gap={0}>
              <Box padding={2} cursor='pointer' onClick={closeModal} alignItems={"center"} >
              ...
              w={100}
              >
                <Text fontSize="xs" color="white" fontWeight="900" textAlign="center">اكتشف خدماتنا</Text>
              </Box>
              </Stack>
              <Stack 
              color="white" 
              ...
              shadow='lg'
              >
                <Text fontSize="xs" color="rgba(187, 150, 97, 1)" fontWeight="900" textAlign="right">{congratsData[lang].musaliyaatTitle}</Text>
                <Text fontSize="xs" textAlign="justify">{congratsData[lang].musaliyaatDesc}</Text>
