...
حرصًا على راحتكم وسهولة أداء مناسككم، نرجو الالتزام بالإرشادات التالية:`,
  ...
  fr: {
    ...
    conditionsStatment: `Chers hôtes du Tout Miséricordieux, Pour votre confort et afin de faciliter l’accomplissement de vos rites, nous vous prions de bien respecter les directives suivantes :`,
  ...
  tr: {
    ...
    conditionsStatment: `Rahman olan Allah’ın Kıymetli Misafirleri, Rahatınızı ve ibadetlerinizi kolaylıkla yerine getirebilmenizi sağlamak için lütfen aşağıdaki kurallara uyunuz:`,
  ...
  ur: {
    ...
    conditionsStatment: `رحمن کے مہمانو! آپ اپنی راحت اور عبادت کی ادائیگی میں سہولت کے پیش نظرہم امید کرتے ہیں کہ درج ذیل تعلمیات کی پابندی کریں:`,
        ...
        <ModalBody>
          <VStack spacing={4}>
            ...
            <Text
              ...
              px={4}
              lineHeight="1.5"
              style={{ direction: pageDir, whiteSpace: "pre-line" }}
            >
